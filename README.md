...
Este repositório fornece um conjunto padronizado e modular de **17 regras MDC** para desenvolvimento assistido por IA no Cursor IDE, organizadas seguindo as melhores práticas de:
...
```
cursor-mdc-rules/
├── .cursor/rules/           # 17 Regras Project Rules v2 (.mdc)
...
│   └── 76-lovable-integration.mdc      # Integração Lovable AI-Assisted Development
